package com.huiwtech.film.example.alipay.trade;
...
import com.huiwtech.film.example.alipay.trade.config.Configs;
import com.huiwtech.film.example.alipay.trade.model.ExtendParams;
import com.huiwtech.film.example.alipay.trade.model.GoodsDetail;
import com.huiwtech.film.example.alipay.trade.model.builder.*;
import com.huiwtech.film.example.alipay.trade.model.hb.*;
import com.huiwtech.film.example.alipay.trade.model.result.AlipayF2FPayResult;
import com.huiwtech.film.example.alipay.trade.model.result.AlipayF2FPrecreateResult;
import com.huiwtech.film.example.alipay.trade.model.result.AlipayF2FQueryResult;
import com.huiwtech.film.example.alipay.trade.model.result.AlipayF2FRefundResult;
import com.huiwtech.film.example.alipay.trade.service.AlipayMonitorService;
import com.huiwtech.film.example.alipay.trade.service.AlipayTradeService;
import com.huiwtech.film.example.alipay.trade.service.impl.AlipayMonitorServiceImpl;
import com.huiwtech.film.example.alipay.trade.service.impl.AlipayTradeServiceImpl;
import com.huiwtech.film.example.alipay.trade.service.impl.AlipayTradeWithHBServiceImpl;
import com.huiwtech.film.example.alipay.trade.utils.Utils;
import com.huiwtech.film.example.alipay.trade.utils.ZxingUtils;
    ...
    public void test_trade_precreate() {
        ...
        switch (result.getTradeStatus()) {
            case SUCCESS:
                ...
                // 需要修改为运行机器上的路径
                String filePath = String.format("C:/Users/A/Desktop/qr-code/qr-%s.png",
