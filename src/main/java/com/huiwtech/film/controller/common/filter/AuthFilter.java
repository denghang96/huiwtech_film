package com.huiwtech.film.controller.common.filter;


import com.alibaba.fastjson.JSON;
import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.huiwtech.film.config.properties.JwtProperties;
import com.huiwtech.film.controller.auth.util.JwtTokenUtil;
import com.huiwtech.film.controller.common.BaseResponseVO;
import com.huiwtech.film.controller.common.TraceUtil;
...
public class AuthFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain) throws IOException, ServletException {
        if (request.getServletPath().equals("/auth")
                || request.getServletPath().contains("/cinema")
                || request.getServletPath().contains("/user/check")
                || request.getServletPath().contains("/user/register")
                || request.getServletPath().contains("/film")
