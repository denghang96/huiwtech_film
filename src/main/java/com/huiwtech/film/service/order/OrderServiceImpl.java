...
import com.huiwtech.film.common.utils.ToolUtils;
import com.huiwtech.film.config.properties.OrderProperties;
...
import com.huiwtech.film.dao.mapper.FilmOrderTMapper;
...
//        }
    ...
    public OrderDetailResVO saveOrder(String seatIds, String seatNames, String fieldId, String userId) throws CommonServiceExcetion {
        ...
        // 获取filmId
        CinemaFilmVo cinemaFilmVo = cinemaServiceAPI.describeFilmInfoByFieldId(fieldId);
        ...
        filmOrderT.setFilmId(Integer.parseInt(cinemaFilmVo.getFilmId()));
