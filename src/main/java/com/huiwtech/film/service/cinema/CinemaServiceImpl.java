...
import com.huiwtech.film.dao.entity.FilmAreaDictT;
import com.huiwtech.film.dao.entity.FilmBrandDictT;
import com.huiwtech.film.dao.entity.FilmCinemaT;
import com.huiwtech.film.dao.entity.FilmHallDictT;
...
public class CinemaServiceImpl implements CinemaServiceAPI {
    ...
    @Override
    public boolean checkCondition(int conditionId, ConditionType conditionType){
    ...
    @Override
    public CinemaFilmVo describeFilmInfoByFieldId(String fieldId) {
